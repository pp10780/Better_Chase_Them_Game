...
OBJS = chase_server.o init_server.o movement.o utils_server.o chase_client.o global_var.o
OUT	= server, client

OBJS0	= $(OBJDIR)/chase_server.o $(OBJDIR)/init_server.o $(OBJDIR)/movement.o $(OBJDIR)/utils_server.o $(OBJDIR)/global_var.o
SOURCE0	= chase_server.c init_server.c movement.c utils_server.c global_var.c
HEADER0	= defines.h init_server.h movement.h structs.h utils_server.h global_var.h
OUT0	= $(OUTDIR)/server
SRCDIR0 = Server
